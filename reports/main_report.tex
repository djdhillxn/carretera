...
Experiments run in a hosted Colab GPU VM with packaged CARLA 0.9.16 extracted
to ephemeral local storage. A validated archive and experiment artifacts are
persisted separately in Google Drive. Training is checkpointed in
5,000-decision chunks and evaluation in restartable paired slices; resolved
configuration, package versions, archive hash, manifest hash, hostname, and
runtime metadata are retained with the artifacts.
